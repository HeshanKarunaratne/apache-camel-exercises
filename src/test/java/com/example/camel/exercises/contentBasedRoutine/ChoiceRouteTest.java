...
class ChoiceRouteTest extends CamelTestSupport {
    ...
    public static final String GADGET = ChoiceRoute.GADGET;
    public static final String WIDGET = ChoiceRoute.WIDGET;
    public static final String GENERAL = ChoiceRoute.GENERAL;
    public static final String INVENTORY = ChoiceRoute.INVENTORY;
